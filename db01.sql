...
INSERT INTO `bottom` (`id`, `bottom`, `sh`) VALUES
(1, '2026-01-01 頁尾版權', 0);
...
(1, '管理登入', 'index.php?do=login', 0, 0),
(2, '網站首頁', 'index.php', 1, 0),
(5, '更多內容', 'index.php', 1, 0),
(8, '111', '111', 0, 1),
(9, '111', '111', 0, 1);
...
INSERT INTO `total` (`id`, `total`, `text`, `sh`) VALUES
(1, 111110000, '', 0);
