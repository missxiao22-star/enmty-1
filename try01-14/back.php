...
<body>
	...
	<div id="main">
		<?php 
			$img=$Title->find(['sh'=>1]);
		?>
		<a title="<?=$img['text']?>" href="index.php">
			<div class="ti" style="background:url('./upload/<?=$img['img']?>'); background-size:cover;"></div>
			<!--標題-->
		</a>
		<div id="ms">
					...
					<tbody>
						<tr>
							<td style="width:70%;font-weight:800; border:#333 1px solid; border-radius:3px;"
								class="cent"><a href="?do=login" style="color:#000; text-decoration:none;">後台管理區</a>
							</td>
